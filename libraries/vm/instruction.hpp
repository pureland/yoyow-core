...
/*
   This instruction set is fully compatible with instructions of EVM , but following different
   1.No gas and gas price , tx cost calculated by cpu time ; block creator judg a tx if over cost, other node comply with it
   2.add instruction for function
   3.contract can update
*/
